"""
Django settings for EURIQA project.
...
MEDIA_ROOT = os.path.join(BASE_DIR,'static2/profilephotos')
...
WSGI_APPLICATION = 'EURIQA.wsgi.application'
...
# CSRF Trusted Domain
CSRF_TRUSTED_ORIGINS = ['https://euriqa.azurewebsites.net', 'https://euriqastorage.blob.core.windows.net/referencephotos/college1.jpg']
